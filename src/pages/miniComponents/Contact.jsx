...
const Shimmer = () => {
  return (
    <div className="animate-pulse space-y-6 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md max-w-lg mx-auto">
      ...
      <div className="h-12 w-full sm:w-52 bg-gray-300 dark:bg-gray-700 rounded"></div>
    </div>
  );
};
